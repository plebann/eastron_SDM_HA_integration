...
class SDM120RegisterMap:
    ...
    REGISTERS: tuple[SDMRegister, ...] = (
        ...
        SDMRegister(0x0014, False, "meter_id", "Meter ID", 4, None, "Float", 1.0, "RW", "number", "Config", "Range: 1-247, default 1"),
        SDMRegister(0x001C, False, "baud_rate", "Baud rate", 4, None, "Float", 1.0, "RW", "select", "Config", "Enum: 0=2400, 1=4800, 2=9600, 5=1200 (default 0)"),
        SDMRegister(0x0056, False, "pulse_1_output_mode", "Pulse 1 output mode", 4, None, "Float", 1.0, "RW", "select", "Config", "Enum: 1=import, 2=import+export, 4=export, 5=import reactive, 6=import+export reactive, 8=export reactive (default 4)"),
        SDMRegister(0xF900, False, "time_of_scroll_display", "Time of scroll display", 2, "s", "HEX", 1.0, "RW", "number", "Config", "Range: 0-30, default 0"),
        SDMRegister(0xF910, False, "pulse_1_output", "Pulse 1 output", 2, None, "HEX", 1.0, "RW", "select", "Config", "Enum: 0=0.001kWh/imp (default), 1=0.01, 2=0.1, 3=1"),
        SDMRegister(0xF920, False, "measurement_mode", "Measurement mode", 2, None, "HEX", 1.0, "RW", "select", "Config", "Enum: 1=total=import, 2=import+export (default), 3=import-export"),
...
class SDM630RegisterMap:
    ...
    REGISTERS: tuple[SDMRegister, ...] = (
        ...
        SDMRegister(0x0024, False, "phase_1_phase_angle", "Phase 1 Phase Angle", 4, "Degrees", "Float", 1.0, "RO", "sensor", "Advanced"),
        SDMRegister(0x0026, False, "phase_2_phase_angle", "Phase 2 Phase Angle", 4, "Degrees", "Float", 1.0, "RO", "sensor", "Advanced"),
        SDMRegister(0x0028, False, "phase_3_phase_angle", "Phase 3 Phase Angle", 4, "Degrees", "Float", 1.0, "RO", "sensor", "Advanced"),
        ...
        SDMRegister(0x0042, False, "total_system_phase_angle", "Total System Phase Angle", 4, "Degrees", "Float", 1.0, "RO", "sensor", "Advanced"),
        SDMRegister(0x0046, True, "frequency", "Frequency", 4, "Hz", "Float", 1.0, "RO", "sensor", "Basic", SensorDeviceClass.FREQUENCY),
        ...
        SDMRegister(0x00EA, False, "phase_1_l_n_volts_thd", "Phase 1 L/N Volts THD", 4, "%", "Float", 1.0, "RO", "sensor", "Advanced"),
        SDMRegister(0x00EC, False, "phase_2_l_n_volts_thd", "Phase 2 L/N Volts THD", 4, "%", "Float", 1.0, "RO", "sensor", "Advanced"),
        SDMRegister(0x00EE, False, "phase_3_l_n_volts_thd", "Phase 3 L/N Volts THD", 4, "%", "Float", 1.0, "RO", "sensor", "Advanced"),
        SDMRegister(0x00F0, False, "phase_1_current_thd", "Phase 1 Current THD", 4, "%", "Float", 1.0, "RO", "sensor", "Advanced"),
        SDMRegister(0x00F2, False, "phase_2_current_thd", "Phase 2 Current THD", 4, "%", "Float", 1.0, "RO", "sensor", "Advanced"),
        SDMRegister(0x00F4, False, "phase_3_current_thd", "Phase 3 Current THD", 4, "%", "Float", 1.0, "RO", "sensor", "Advanced"),

...
class SDMRegister:
    ...
    polling: Literal["fast", "normal", "slow"] = "normal"
...
class SDM120RegisterMap:
    ...
    REGISTERS: tuple[SDMRegister, ...] = (
        ...
        SDMRegister(0x0006, False, "current", "Current", 4, "A", "Float", 1.0, "RO", "sensor", "Basic", SensorDeviceClass.CURRENT, polling="fast"),
        SDMRegister(0x000C, False, "power", "Power", 4, "W", "Float", 1.0, "RO", "sensor", "Basic", SensorDeviceClass.POWER, polling="fast"),
        # Normal polling (30s)
        SDMRegister(0x0012, False, "apparent_power", "Apparent power", 4, "VA", "Float", 1.0, "RO", "sensor", "Advanced", SensorDeviceClass.APPARENT_POWER, polling="normal"),
        SDMRegister(0x0018, False, "reactive_power", "Reactive power", 4, "VAr", "Float", 1.0, "RO", "sensor", "Advanced", SensorDeviceClass.REACTIVE_POWER, polling="normal"),
        SDMRegister(0x001E, False, "power_factor", "Power factor", 4, None, "Float", 1.0, "RO", "sensor", "Advanced", SensorDeviceClass.POWER_FACTOR, polling="normal"),
        SDMRegister(0x0046, False, "frequency", "Frequency", 4, "Hz", "Float", 1.0, "RO", "sensor", "Basic", SensorDeviceClass.FREQUENCY, polling="normal"),
        # Slow polling (300s)
        SDMRegister(0x0048, False, "import_energy", "Import energy", 4, "kWh", "Float", 1.0, "RO", "sensor", "Basic", SensorDeviceClass.ENERGY, polling="slow"),
        SDMRegister(0x004A, False, "export_energy", "Export energy", 4, "kWh", "Float", 1.0, "RO", "sensor", "Basic", SensorDeviceClass.ENERGY, polling="slow"),
        ...
        SDMRegister(0x004E, False, "export_reactive_energy", "Export reactive energy", 4, "kvarh", "Float", 1.0, "RO", "sensor", "Advanced", SensorDeviceClass.ENERGY, polling="slow"),
        SDMRegister(0x0054, False, "total_system_power_demand", "Total system power demand", 4, "W", "Float", 1.0, "RO", "sensor", "Diagnostic", SensorDeviceClass.POWER, polling="slow"),
        SDMRegister(0x0056, False, "max_total_system_power_demand", "Max total system power demand", 4, "W", "Float", 1.0, "RO", "sensor", "Diagnostic", SensorDeviceClass.POWER, polling="slow"),
        SDMRegister(0x0058, False, "import_system_power_demand", "Import system power demand", 4, "W", "Float", 1.0, "RO", "sensor", "Diagnostic", SensorDeviceClass.POWER, polling="slow"),
        SDMRegister(0x005A, False, "max_import_system_power_demand", "Max import system power demand", 4, "W", "Float", 1.0, "RO", "sensor", "Diagnostic", SensorDeviceClass.POWER, polling="slow"),
        SDMRegister(0x005C, False, "export_system_power_demand", "Export system power demand", 4, "W", "Float", 1.0, "RO", "sensor", "Diagnostic", SensorDeviceClass.POWER, polling="slow"),
        SDMRegister(0x005E, False, "max_export_system_power_demand", "Max export system power demand", 4, "W", "Float", 1.0, "RO", "sensor", "Diagnostic", SensorDeviceClass.POWER, polling="slow"),
        SDMRegister(0x0102, False, "current_demand", "Current demand", 4, "Amps", "Float", 1.0, "RO", "sensor", "Diagnostic", SensorDeviceClass.CURRENT, polling="slow"),
        SDMRegister(0x0108, False, "max_current_demand", "Max current demand", 4, "Amps", "Float", 1.0, "RO", "sensor", "Diagnostic", SensorDeviceClass.CURRENT, polling="slow"),
        SDMRegister(0x0156, False, "total_energy", "Total energy", 4, "kWh", "Float", 1.0, "RO", "sensor", "Basic", SensorDeviceClass.ENERGY, polling="slow"),
        SDMRegister(0x0158, False, "total_reactive_energy", "Total reactive energy", 4, "kvarh", "Float", 1.0, "RO", "sensor", "Advanced", SensorDeviceClass.ENERGY, polling="slow"),
        # Config/diagnostic: always slow
        SDMRegister(0x000C, False, "relay_pulse_width", "Relay Pulse Width", 4, "ms", "Float", 1.0, "RW", "number", "Config", None, "Enum: 60, 100, 200 (default 100)", polling="slow"),
        SDMRegister(0x0012, False, "network_parity_stop", "Network Parity Stop", 4, None, "Float", 1.0, "RW", "select", "Config", None, "Enum: 0=1 stop/no parity, 1=1 stop/even, 2=1 stop/odd, 3=2 stop/no parity", polling="slow"),
        SDMRegister(
        ...
        SDMRegister(0xFC00, False, "serial_number", "Serial number", 4, None, "UInt32", 1.0, "RO", "sensor", "Diagnostic", "Read only", polling="slow"),
        SDMRegister(0xFC02, False, "meter_code", "Meter code", 2, None, "HEX", 1.0, "RO", "sensor", "Diagnostic", "Read only", polling="slow"),
        SDMRegister(0xFC03, False, "software_version", "Software version", 2, None, "HEX", 1.0, "RO", "sensor", "Diagnostic", "Read only", polling="slow"),
    )
...
class SDM630RegisterMap:
    ...
    REGISTERS: tuple[SDMRegister, ...] = (
        ...
        SDMRegister(0x0016, False, "phase_3_apparent_power", "Phase 3 Apparent Power", 4, "VA", "Float", 1.0, "RO", "sensor", "Advanced", SensorDeviceClass.APPARENT_POWER, polling="normal"),
        SDMRegister(0x0018, True, "phase_1_reactive_power", "Phase 1 Reactive Power", 4, "VAr", "Float", 1.0, "RO", "sensor", "Advanced", SensorDeviceClass.REACTIVE_POWER, polling="normal"),
        SDMRegister(0x001A, True, "phase_2_reactive_power", "Phase 2 Reactive Power", 4, "VAr", "Float", 1.0, "RO", "sensor", "Advanced", SensorDeviceClass.REACTIVE_POWER, polling="normal"),
        SDMRegister(0x001C, True, "phase_3_reactive_power", "Phase 3 Reactive Power", 4, "VAr", "Float", 1.0, "RO", "sensor", "Advanced", SensorDeviceClass.REACTIVE_POWER, polling="normal"),
        SDMRegister(0x001E, False, "phase_1_power_factor", "Phase 1 Power Factor", 4, None, "Float", 1.0, "RO", "sensor", "Advanced", SensorDeviceClass.POWER_FACTOR, polling="normal"),
        SDMRegister(0x0020, False, "phase_2_power_factor", "Phase 2 Power Factor", 4, None, "Float", 1.0, "RO", "sensor", "Advanced", SensorDeviceClass.POWER_FACTOR, polling="normal"),
        SDMRegister(0x0022, False, "phase_3_power_factor", "Phase 3 Power Factor", 4, None, "Float", 1.0, "RO", "sensor", "Advanced", SensorDeviceClass.POWER_FACTOR, polling="normal"),
        SDMRegister(0x0046, True, "frequency", "Frequency", 4, "Hz", "Float", 1.0, "RO", "sensor", "Basic", SensorDeviceClass.FREQUENCY, polling="normal"),
        SDMRegister(0x00EA, False, "phase_1_l_n_volts_thd", "Phase 1 L/N Volts THD", 4, "%", "Float", 1.0, "RO", "sensor", "Advanced", None, polling="normal"),
        SDMRegister(0x00EC, False, "phase_2_l_n_volts_thd", "Phase 2 L/N Volts THD", 4, "%", "Float", 1.0, "RO", "sensor", "Advanced", None, polling="normal"),
        SDMRegister(0x00EE, False, "phase_3_l_n_volts_thd", "Phase 3 L/N Volts THD", 4, "%", "Float", 1.0, "RO", "sensor", "Advanced", None, polling="normal"),
        SDMRegister(0x00F0, False, "phase_1_current_thd", "Phase 1 Current THD", 4, "%", "Float", 1.0, "RO", "sensor", "Advanced", None, polling="normal"),
        SDMRegister(0x00F2, False, "phase_2_current_thd", "Phase 2 Current THD", 4, "%", "Float", 1.0, "RO", "sensor", "Advanced", None, polling="normal"),
        SDMRegister(0x00F4, False, "phase_3_current_thd", "Phase 3 Current THD", 4, "%", "Float", 1.0, "RO", "sensor", "Advanced", None, polling="normal"),
        # Slow polling (300s): energy, demand, diagnostics, config, phase angle
        SDMRegister(0x0048, True, "total_import_kwh", "Total Import kWh", 4, "kWh", "Float", 1.0, "RO", "sensor", "Basic", SensorDeviceClass.ENERGY, polling="slow"),
        ...
        SDMRegister(0x0042, False, "total_system_phase_angle", "Total System Phase Angle", 4, "Degrees", "Float", 1.0, "RO", "sensor", "Advanced", None, polling="slow"),
        SDMRegister(0x0024, False, "phase_1_phase_angle", "Phase 1 Phase Angle", 4, "Degrees", "Float", 1.0, "RO", "sensor", "Advanced", None, polling="slow"),
        SDMRegister(0x0026, False, "phase_2_phase_angle", "Phase 2 Phase Angle", 4, "Degrees", "Float", 1.0, "RO", "sensor", "Advanced", None, polling="slow"),
        SDMRegister(0x0028, False, "phase_3_phase_angle", "Phase 3 Phase Angle", 4, "Degrees", "Float", 1.0, "RO", "sensor", "Advanced", None, polling="slow"),
        SDMRegister(0x002E, False, "average_line_current", "Average Line Current", 4, "Amps", "Float", 1.0, "RO", "sensor", "Advanced", SensorDeviceClass.CURRENT, polling="slow"),
        SDMRegister(0x0030, False, "sum_of_line_currents", "Sum of Line Currents", 4, "Amps", "Float", 1.0, "RO", "sensor", "Advanced", SensorDeviceClass.CURRENT, polling="slow"),
        SDMRegister(0x0054, False, "total_system_power_demand", "Total System Power Demand", 4, "W", "Float", 1.0, "RO", "sensor", "Diagnostic", SensorDeviceClass.POWER, polling="slow"),
        SDMRegister(0x0056, False, "max_total_system_power_demand", "Max Total System Power Demand", 4, "W", "Float", 1.0, "RO", "sensor", "Diagnostic", SensorDeviceClass.POWER, polling="slow"),
        SDMRegister(0x0064, False, "total_system_va_demand", "Total System VA Demand", 4, "VA", "Float", 1.0, "RO", "sensor", "Diagnostic", SensorDeviceClass.APPARENT_POWER, polling="slow"),
        SDMRegister(0x0066, False, "max_total_system_va_demand", "Max Total System VA Demand", 4, "VA", "Float", 1.0, "RO", "sensor", "Diagnostic", SensorDeviceClass.APPARENT_POWER, polling="slow"),
        SDMRegister(0x0156, False, "total_kwh", "Total kWh", 4, "kWh", "Float", 1.0, "RO", "sensor", "Basic", SensorDeviceClass.ENERGY, polling="slow"),
        SDMRegister(0x0158, False, "total_kvarh", "Total kVArh", 4, "kVArh", "Float", 1.0, "RO", "sensor", "Advanced", SensorDeviceClass.ENERGY, polling="slow"),
        # Config/diagnostic: always slow
        SDMRegister(0x0002, False, "demand_period", "Demand Period", 4, "min", "Float", 1.0, "RW", "select", "Config", "Enum: 0, 5, 8, 10, 15, 20, 30, 60 (default 60)", polling="slow"),
        SDMRegister(0x000A, False, "system_type", "System Type", 4, None, "Float", 1.0, "RW", "select", "Config", "Enum: 3p4w=3, 3p3w=2, 1p2w=1 (password protected)", polling="slow"),
        SDMRegister(0x000C, False, "pulse1_width", "Pulse1 Width", 4, "ms", "Float", 1.0, "RW", "number", "Config", "Enum: 60, 100, 200 (default 100)", polling="slow"),
        SDMRegister(0x000E, False, "password_lock", "Password Lock", 4, None, "Float", 1.0, "RW", "button", "Config", "Write any value to lock, read resets timeout", polling="slow"),
        SDMRegister(0x0012, False, "network_parity_stop", "Network Parity Stop", 4, None, "Float", 1.0, "RW", "select", "Config", "Enum: 0=1 stop/no parity, 1=1 stop/even, 2=1 stop/odd, 3=2 stop/no parity", polling="slow"),
        SDMRegister(0x0014, False, "network_node", "Network Node", 4, None, "Float", 1.0, "RW", "number", "Config", "Range: 1-247, default 1", polling="slow"),
        SDMRegister(0x0016, False, "pulse1_divisor1", "Pulse1 Divisor1", 4, None, "Float", 1.0, "RW", "select", "Config", "Enum: 0=0.0025, 1=0.01, 2=0.1, 3=1, 4=10, 5=100 kWh/imp", polling="slow"),
        SDMRegister(0x0018, False, "password", "Password", 4, None, "Float", 1.0, "RW", "number", "Config", "Enter password for protected registers", polling="slow"),
        SDMRegister(0x001C, False, "network_baud_rate", "Network Baud Rate", 4, None, "Float", 1.0, "RW", "select", "Config", "Enum: 0=2400, 1=4800, 2=9600 (default), 3=19200, 4=38400", polling="slow"),
        SDMRegister(0x0056, False, "pulse_1_energy_type", "Pulse 1 Energy Type", 4, None, "Float", 1.0, "RW", "select", "Config", "Enum: 1=import, 2=total, 4=export (default), 5=import reactive, 6=total reactive, 8=export reactive", polling="slow"),
        SDMRegister(0xF010, False, "reset", "Reset", 2, None, "HEX", 1.0, "RW", "button", "Config", "Write 0x0000 to reset max demand", polling="slow"),
        SDMRegister(0xFC00, False, "serial_number", "Serial number", 4, None, "UInt32", 1.0, "RO", "sensor", "Diagnostic", "Read only", polling="slow"),
    )
